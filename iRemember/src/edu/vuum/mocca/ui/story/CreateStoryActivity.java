...
public class CreateStoryActivity extends StoryActivityBase {
	...
	private void launchSoundIntent() {
		...
		// TODO_ - Create a new intent to launch the SoundRecordActivity activity
		Intent audioActivity = new Intent(getApplicationContext(), SoundRecordActivity.class);
		
		// TODO_ - Use getOutputMediaFile() to create a new 
		// filename for this specific sound file
		File file = getOutputMediaFile(MEDIA_TYPE_AUDIO);
		
		
		// TODO_ - Add the filename to the Intent as an extra. Use the Intent-extra name
		// from the SoundRecordActivity class, EXTRA_OUTPUT
		audioActivity.putExtra(SoundRecordActivity.EXTRA_OUTPUT, file.getAbsolutePath().toString());

		
		// TODO_ - Start a new activity for result, using the new intent and the request
		// code MIC_SOUND_REQUEST
		startActivityForResult(audioActivity, MIC_SOUND_REQUEST);
	...
	private void launchCameraIntent() {
		...
		// TODO_ - Create a new intent to launch the MediaStore, Image capture function
		...
		// TODO_ - Set the imagePath for this image file using the pre-made function
		...
		i.putExtra(MediaStore.EXTRA_OUTPUT, imagePath.getAbsolutePath().toString());
	...
	private void launchVideoCameraIntent() {
		...
		// TODO_ - Set the fileUri for this video file using the pre-made function
		// getOutputMediaFile to create a new filename for this specific video;
		File fileUri = getOutputMediaFile(MEDIA_TYPE_VIDEO);

		
		// TODO_ - Add the filename to the Intent as an extra. Use the Intent-extra name
		// from the MediaStore class, EXTRA_OUTPUT
		i.putExtra(MediaStore.EXTRA_OUTPUT, fileUri.getAbsolutePath().toString());

		
		// TODO_ - Specify as an extra that the video quality should be HIGH. Use the
